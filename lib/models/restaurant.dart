...
import 'package:orderpizza/models/cart_item.dart';
...
class Restaurant extends ChangeNotifier {
  final List<Food> _menu = [
    ...
    Food(
      ...
      price: 5.99,
      image: "lib/images/burgers/cheeseburger.png",
    ...
    Food(
      ...
      price: 6.99,
      image: "lib/images/burgers/baconburger.png",
      category: FoodCategory.burgers,
      availableAddons: [
        Addon(name: "Extra Cheese", price: 0.50),
        Addon(name: "Bacon", price: 1.00),
    ...
    Food(
      ...
      price: 7.99,
      image: "lib/images/burgers/avocadoburger.png",
      category: FoodCategory.burgers,
      availableAddons: [
        Addon(name: "Extra Cheese", price: 0.50),
        Addon(name: "Bacon", price: 1.00),
    ...
    Food(
      ...
      price: 9.99,
      image: "lib/images/pizzas/pepperonipizza.png",
    ...
    Food(
      ...
      price: 10.99,
      image: "lib/images/pizzas/vegetarianpizza.png",
      category: FoodCategory.pizzas,
      availableAddons: [
        Addon(name: "Extra Cheese", price: 0.50),
        Addon(name: "Bacon", price: 1.00),
    ...
    Food(
      ...
      price: 11.99,
      image: "lib/images/pizzas/hawaiianpizza.png",
      category: FoodCategory.pizzas,
      availableAddons: [
        Addon(name: "Extra Cheese", price: 0.50),
        Addon(name: "Bacon", price: 1.00),
    ...
    Food(
      ...
      price: 4.99,
      image: "lib/images/salads/gardensalad.png",
    ...
    Food(
      ...
      price: 5.99,
      image: "lib/images/salads/vietnamesesalad.png",
      category: FoodCategory.salads,
      availableAddons: [
        Addon(name: "Grilled Chicken", price: 2.00),
        Addon(name: "Shrimp", price: 3.00),
    ...
    Food(
      ...
      price: 6.99,
      image: "lib/images/salads/greeksalad.png",
      category: FoodCategory.salads,
      availableAddons: [
        Addon(name: "Grilled Chicken", price: 2.00),
        Addon(name: "Shrimp", price: 3.00),
    ...
    Food(
      ...
      price: 1.99,
      image: "lib/images/drinks/coca.png",
    ...
    Food(
      ...
      price: 1.99,
      image: "lib/images/drinks/sprite.png",
      category: FoodCategory.drinks,
      availableAddons: [],
    ),
    Food(
      ...
      price: 2.99,
      image: "lib/images/drinks/icedtea.png",
      category: FoodCategory.drinks,
      availableAddons: [],
    ),
  ];
